...
def speech_callback(recognizer, audio):
    global conversation_active, current_name
    winsound.Beep(1000, 200)  # Beep when starting to listen
    try:
        ...
        winsound.Beep(800, 200)  # Beep when ending listening
    except sr.UnknownValueError:
        winsound.Beep(800, 200)  # Beep when ending listening (on error)
        pass
